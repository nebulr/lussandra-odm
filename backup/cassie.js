...
exports.connect = function (config) {
    ...
    Cassie.contactPoints = config.contactPoints;
...
exports.checkKeyspace = function (config, options, callback) {
    var client = new cql.Client({contactPoints: config.contactPoints});
...
exports.syncTables = function (config, options, callback) {
    if (typeof options === 'function') {
        callback = options;
        options = {};
        options.keyspace_check = true; //Checks if keyspace exists by default - creates a separate connection using config.contactPoints & config.user/password if provided
