...
Types.prototype.DOUBLE = function () {
  var validators = [
    validator.isFloat
  ];
  function toCQLString(obj) {
...
Types.prototype.TIMESTAMP = function() {
  ...
  function toCQLString(obj, insert) {
    return moment.utc(obj).valueOf(); // This clones the underlying moment object, puts it in utc mode, and the returns date as UTC string
  }
  function toObject(obj) {
    return moment.utc(obj).toDate();
  }
  function validate(obj, userValidators) {
    var vArr = validators.concat(userValidators);
    var result = util.validateAll(obj, vArr);
...
Types.prototype.INT = function() {
  ...
  function toObject(obj) {
    return (typeof obj === 'string')? parseInt(obj) : obj;
  }
  function validate(obj, userValidators) {
    var vArr = validators.concat(userValidators);
    var result = util.validateAll(obj, vArr);
