...
cassandra.prototype.connect  = function(done) {
  ...
  //
  var client = new Client ({ contactPoints : this._connectionOptions.contactPoints });
  sync.checkKeyspaceExists (client, this._connectionOptions.keyspace, this._connectionOptions)
  .then (function () {
