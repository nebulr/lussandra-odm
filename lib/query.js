...
module.exports = function(instance, opts) {
  ...
  function update (instance, updateParams) {
    ...
    return new Promise (function (resolve, reject) {
        ...
        if (self.instance._internalState.m_dirtyFields.length === 0){
            resolve(self.instance);  //nothing to do.. just callback
            return;
        }
        ...
        if (!checkValid(self.instance)) {
            reject("Object is not valid!", null)
        }
        ...
        self.instance._client.execute(sql, allParams, query.options)
  ...
  function insert (instance, params) {
      ...
      return new Promise (function( resolve, reject ) {
        ...
        instance._client.execute(sql, self.params.values, query.options)
        .then (function(data) {
            self.instance._markClean();
            self.instance._runPost();
            resolve(self.instance);
  ...
  function find (instance, params, criteria) {
    ...
    return new Promise (function (resolve, reject) {
        ...
        self.instance._client.execute(sql, self.params, query.options)
